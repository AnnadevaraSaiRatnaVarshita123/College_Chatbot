...
# Configure models
genai.configure(api_key="AIzaSyCRr8ZphtLC2RV2O85R4EVYANkU4fYk79Q")
...
# App Header
st.markdown('<h1 class="college-font">🏫🤖 SVECW Buddy – Your Ultimate Campus Guide! 🎯📚 Ask away and unlock all things SVECW! 🚀</h1>', unsafe_allow_html=True)
st.markdown('<h3 class="college-font">🤔Ask me anything! 🚀✨ Your answers are just a question away! 💬🔍</h3>', unsafe_allow_html=True)
st.markdown("---")
