...
st.title("🏫🤖 SVECW Buddy – Your Ultimate Campus Guide! 🎯📚 Ask away and unlock all things SVECW! 🚀✨")
st.write("🎓 Welcome to Your College Companion! 🤖💡 Ask me anything about campus life, courses, or events—I'm here to help!")

for message in st.session_state.messages:
    with st.chat_message(message["role"]):
        st.markdown(message["content"])

if prompt := st.chat_input("🤔Ask me anything! 🚀✨ Your answers are just a question away! 💬🔍....."):
